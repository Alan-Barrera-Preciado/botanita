...
motor_Izq.kalman.setGananciasQR([1e-6, 5e-18], [8e-6, 5e-12]) # Ganancias Q R
# configuraciones LQR penalizacion ([I, V], | R) 
motor_Izq.lqr.setPenalizacionesQR([5e-4, 215], 10) # Penalizacion Q (referencia) | Penalizacion R (accion control)
...
# configuraciones Kalman
motor_Der.kalman.setGananciasQR([1e-7, 5e-17], [3e-5, 5e-10]) # Ganancias Q R
# configuraciones LQR penalizacion ([I, V], | R)
motor_Der.lqr.setPenalizacionesQR([10, 255], 80) # Penalizacion Q (referencia) | Penalizacion R (accion control)
