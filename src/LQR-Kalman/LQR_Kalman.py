...
motor_Izq.kalman.setGananciasQR([1e-7, 5e-16], [3e-7, 5e-9]) # Ganancias Q R
...
# configuraciones LQR penalizacion ([I, V], | R) 
motor_Der.lqr.setPenalizacionesQR([5e-4, 215], 10) # Penalizacion Q (referencia) | Penalizacion R (accion control)
