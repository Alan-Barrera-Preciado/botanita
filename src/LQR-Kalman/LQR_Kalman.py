...
motor_Izq.kalman.setGananciasQR([1e-8, 5e-14], [3e-10, 5e-10]) # Ganancias Q R
# configuraciones LQR penalizacion ([I, V], | R) 
motor_Izq.lqr.setPenalizacionesQR([5e-2, 255], 10) # Penalizacion Q (referencia) | Penalizacion R (accion control)
