...
motor_Izq.kalman.setGananciasQR([1e-6, 5e-9], [8e-10, 5e-12]) # Ganancias Q R
...
# configuraciones LQR penalizacion ([I, V], | R) 
motor_Der.lqr.setPenalizacionesQR([5e-2, 215], 10) # Penalizacion Q (referencia) | Penalizacion R (accion control)
